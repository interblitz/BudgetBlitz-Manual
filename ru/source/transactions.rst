...
Любые изменения денежных средств приложение учитывает при помощи операций. Ввод начальных остатков,
...
с признаком Исключаемая из портфеля. По умолчанию при установке приложение создает статью Перевод в рамках
