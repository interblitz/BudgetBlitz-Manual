...
Для этого Алиса открывает список узлов обмена (:menuselection:`Действия --> Обмен данными -->  Узлы обмена`). В справочнике
узлов обмена Алиса выбирает пункт меню :menuselection:`Отправить идентификатор` и отправляет идентификатор своего узла
