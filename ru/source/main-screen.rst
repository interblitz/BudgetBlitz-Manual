...
типов портфелей, то на экране будет несколько сводок. В примерах ниже рассматривается вариант с
...
В следующем примеру задается фильтр по счетам.
...
скопированы. Остается указать название настройки, например :dfn:`Filtered summary`, и
