...
Открыть любой справочник можно из панели быстрых кнопок или меню действия в зависимости от того,
...
Настройка импорта SMS определяет как именно будут распознаваться операции. Подробнее о настройках импорта SMS см ref`chapter_sms_import_tunes`.

Значения по умолчанию будут устанавливаться при создании операций вручную. Также они будут использоваться при любом
импорте и обмене данными, если нужное значение не будет найдено.
...
рассмотрен в `вопросах и ответах (Как хадать кредитный лимит)`_.
