...
Следует обратить внимание на портфель :dfn:`Универсальный`. В старых версиях этот портфель называется :dfn:`00 Не указано`.
Аналитики этого портфеля доступны для использования в любом другом портфеле. Например, статья :dfn:`Перевод в рамках портфеля`
принадлежит портфелю :dfn:`Универсальный` и может быть выбрана в любой операции вне зависимости от выбранного счета и
связанного с ним типа портфеля.

.. note:: Аналитики портфеля :dfn:`Универсальный` доступны для всех счетов
