...
После настройки параметров можно приступать ко второму этапу настройки.
...
Тем не менее, есть и общие для обоих учетов статьи и другие аналитик. Они принадлежат универсальному типу портфеля и
...
Начальный остаток по счету заносится операцией. Дата операции может любой, но желательно, чтобы операция была первой в писке операций. В качестве статьи
...
следует указать статью Изменение кредитного лимита. Обратите внимание, что это техническая статья,
у нее отключены признаки Доходная и Расходная. Подробней причины ввода кредитного лимита операциями
...
#. ввести приходную (положительную) операцию на сумму 1000 |c| по статье "Кредиты (Я должен)" и указать плательщика или персону --- кому должны.
#. ввести расходную (отрицательную) операцию на сумму 1000 |c| по статье "Не указано", либо задать статью, если известно, на что были потрачены средства.
