...
#. Нажмите :guilabel:`Импорт`. Кнопка будет доступна, если есть отмеченные SMS.
...
#. Нажмите :guilabel:`Далее` и отметьте галочками строки для импорта.
#. Нажмите :guilabel:`Импорт`. Кнопка будет доступна, если есть отмеченные строки.
#. Проверьте результат в списке операций.
#. Проблемы, возникшие при импорте, можно увидеть в журнале событий.
