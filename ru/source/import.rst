...
#. Нажмите Импорт. Кнопка будет доступна, если есть отмеченные SMS.
...
#. Нажмите далее и отметьте галочками строки для импорта.
#. Нажмите Импорт. Кнопка будет доступна, если есть отмеченные строки.
#. Проверьте результат в списке операций.
#. Проблемы, возникшие при импорте, можно увидеть в журнале событий.
