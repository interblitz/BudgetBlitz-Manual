...
операции, то достаточно отметить любую операцию из списка, а затем в панели действий выбрать :guilabel:`Отметить все`.

Редактирование
--------------

Для редактирования выбранных операций следует нажать :guilabel:`Редактировать`. Приложение откроет диалог, в котором
...
Для удаления выбранных операций следует нажать :guilabel:`Удалить`. После подтверждения приложение удалит выбранные элементы.
...
Для создания фильтра на основании выбранных элементов следует нажать :guilabel:`Фильтр`.
...
пункт меню :guilabel:`Отправить при обмене`.
...
Выделенные операции можно экспортировать в файлы формата CSV и OFX, используя пункты меню :guilabel:`Экспорт CSV`
и :guilabel:`Экспорт OFX`. В отличие от операции, элементы справочников можно экспортировать только в файлы формата
CSV.
...
Отправить исходные данные можно через пункт меню :guilabel:`Отправить разработчику`. Перед отправкой
